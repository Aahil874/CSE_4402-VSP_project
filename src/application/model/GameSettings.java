...
public final class GameSettings {
    public enum Difficulty {
        ...
        /**
         * Returns an aggressiveness multiplier for AI swing calculations.
         * Leverages existing AI accuracy and contact chance settings.
         */
        public double getAiAggressiveness() { 
            return rivalContactChance * aiAccuracy * 2.5; 
        }
